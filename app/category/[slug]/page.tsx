    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-md p-8 max-w-lg w-full">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">एक त्रुटि हुई</h2>
          <p className="text-gray-500 mb-6">समाचार लोड करने में समस्या आई है। कृपया कुछ देर बाद पुनः प्रयास करें।</p>
          <div className="text-sm text-gray-400">
            <p>Debug Info:</p>
